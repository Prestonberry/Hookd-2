...
        .plans-grid { display: grid; grid-template-columns: repeat(3, 1fr) !important; gap: 20px; margin-bottom: 40px; }
        .plan-card { background: #141414; border: 1px solid #2A2A2A; border-radius: 16px; padding: 32px 28px; position: relative; display: flex; flex-direction: column; min-width: 0; }
...
        .plan-name { font-family: 'Syne', sans-serif; font-size: 22px; font-weight: 800; margin-bottom: 8px; }
        .plan-desc { font-size: 13px; color: #666; line-height: 1.5; margin-bottom: 24px; }
        .plan-price { display: flex; align-items: baseline; gap: 2px; margin-bottom: 28px; }
        .price-dollar { font-size: 20px; font-weight: 600; color: #888; }
        .price-amount { font-family: 'Syne', sans-serif; font-size: 52px; font-weight: 800; line-height: 1; }
...
        .plan-features li { font-size: 14px; color: #FAFAFA; display: flex; align-items: flex-start; gap: 10px; line-height: 1.4; }
        .check { color: #00E87A; font-weight: 700; flex-shrink: 0; }
        .plan-btn { width: 100%; padding: 16px; border-radius: 10px; font-family: 'Syne', sans-serif; font-size: 16px; font-weight: 700; cursor: pointer; transition: all 0.2s; border: none; }
