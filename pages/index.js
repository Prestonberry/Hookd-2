    ...
    <>
      ...
      <style jsx global>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .modal { background: #141414; border: 1px solid #2A2A2A; border-radius: 20px; padding: 40px; max-width: 560px; width: 100%; text-align: center; margin-left: 40px; }
        ...
        .paywall-plans { display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px; margin-bottom: 20px; width: 100%; margin-left: auto; margin-right: auto; }
