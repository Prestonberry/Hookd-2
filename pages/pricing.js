...
        .plans-section { max-width: 760px; margin: 0 auto; padding: 0 20px 80px; }
        .plans-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px; margin-bottom: 40px; }
        .plan-card { background: #141414; border: 1px solid #2A2A2A; border-radius: 16px; padding: 20px 14px; position: relative; display: flex; flex-direction: column; min-width: 0; }
        .plan-card.highlighted { border-color: #FF3B00; background: #1A0A0A; }
        .popular-badge { position: absolute; top: -12px; left: 50%; transform: translateX(-50%); background: #FF3B00; color: white; font-size: 10px; font-weight: 700; padding: 4px 12px; border-radius: 20px; letter-spacing: 0.5px; text-transform: uppercase; white-space: nowrap; }
...
        .plan-desc { font-size: 11px; color: #666; line-height: 1.5; margin-bottom: 16px; }
        .plan-price { display: flex; align-items: baseline; gap: 2px; margin-bottom: 16px; }
        .price-dollar { font-size: 16px; font-weight: 600; color: #888; }
        .price-amount { font-family: 'Syne', sans-serif; font-size: 36px; font-weight: 800; line-height: 1; }
        .price-period { font-size: 12px; color: #666; margin-left: 2px; }
        .plan-features { list-style: none; display: flex; flex-direction: column; gap: 8px; margin-bottom: 20px; flex: 1; }
        .plan-features li { font-size: 12px; color: #FAFAFA; display: flex; align-items: flex-start; gap: 6px; line-height: 1.4; }
        .check { color: #00E87A; font-weight: 700; flex-shrink: 0; }
        .plan-btn { width: 100%; padding: 12px; border-radius: 10px; font-family: 'Syne', sans-serif; font-size: 14px; font-weight: 700; cursor: pointer; transition: all 0.2s; border: none; }
