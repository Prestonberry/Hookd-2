    ...
    <>
      ...
      <style jsx global>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-btn { display: inline-block; background: #8B4A2F; color: #EDE6DC; padding: 16px 32px; border-radius: 10px; font-family: 'Archivo Black', sans-serif; font-size: 16px; font-weight: 400; text-decoration: none; transition: background 0.2s; letter-spacing: -0.3px; }
        ...
        .cta-btn { display: inline-block; background: #8B4A2F; color: #EDE6DC; padding: 18px 40px; border-radius: 10px; font-family: 'Archivo Black', sans-serif; font-size: 18px; font-weight: 400; text-decoration: none; transition: background 0.2s; margin-bottom: 16px; letter-spacing: -0.3px; }
