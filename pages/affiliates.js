    ...
    <>
      ...
      <style jsx global>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-btn-disabled, .hero-btn-disabled:hover { background: #2A2A2A; color: #777; cursor: not-allowed; border: 1px solid #3A3A3A; }
        .cta-btn-disabled, .cta-btn-disabled:hover { background: #2A2A2A; color: #777; cursor: not-allowed; border: 1px solid #3A3A3A; }
